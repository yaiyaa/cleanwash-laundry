                    ...
                    <div class="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            >
                                <svg width="30" height="30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <path stroke-linecap="round" stroke-width="2" d="M8 8h8M8 12h8M8 16h5" />
                                </svg>
                            </div>

                            <div>
                                <p class="text-xs font-semibold uppercase tracking-wider" style="color: #5c8aa5;">
                        ...
                        @php
                            $statusStyle = match ($transaksi->status) {
                                'Diterima' => ['background' => '#e8f5ff', 'color' => '#0f6fb5'],
                                'Dicuci' => ['background' => '#eff6ff', 'color' => '#2563eb'],
                                'Disetrika' => ['background' => '#fff7ed', 'color' => '#c2410c'],
                                'Selesai' => ['background' => '#ecfdf5', 'color' => '#15803d'],
                                'Diambil' => ['background' => '#f3f4f6', 'color' => '#4b5563'],
                        ...
                        <div
                            ...
                            style="background-color: {{ $statusStyle['background'] }}; color: {{ $statusStyle['color'] }};"
                        >
                            <span class="mr-2 h-2 w-2 rounded-full" style="background-color: {{ $statusStyle['color'] }};"></span>
                            {{ $transaksi->status }}
                        </div>
